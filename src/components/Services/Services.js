          ...
          <Row>
            <Col xs='12' md='6'>
              <div className='services_box services_logo-left'>
                <img src={coretoken} alt='core-token'></img>
              </div>
            </Col>
            <Col xs='12' md='6'>
              <div className='services_box text-left'>
                <p>
                ...
                <Button className='services_btn'>One page</Button>
              </div>
            </Col>
            <Col xs='12' md='6'>
              <div className='services_box text-right'>
            ...
            <Col xs='12' md='6'>
              <div className='services_box services_logo-left'>
                <img src={wallmoney} alt='wall-money'></img>
              </div>
            </Col>
            <Col xs='12' md='6'>
              <div className='services_box text-left'>
            ...
            <Col xs='12' md='6'>
              <div
                ...
                style={coreHeight}
              >
                <img src={corepay} alt='core-pay' className='core-pay'></img>
              </div>
            </Col>
          </Row>
        </Container>
