  ...
  render() {
    return (
      <section id='case' className='case'>
        ...
        <Container>
          <Row>
            <div className='case_left d-none d-md-block'>
              <div className='case_left-post has-thumb'>
                <a href='https://toktokey.com/' target='blank'>
                  {' '}
                  <img src={logoOne} alt='toktokey' id='ttk'></img>
                </a>
              </div>
              ...
              <div className='case_left-post has-thumb'>
                <a target='blank' href='/#'>
                  <img src={logoThree} alt='metallum' id='metalum'></img>
                </a>
              </div>
              <div className='case_left-post'>
              ...
              <div className='case_left-post has-thumb'>
                <a href='https://cminers.com/' target='blank'>
                  <img src={logoFive} alt='cminers' id='miners'></img>
                </a>
              </div>
              <div className='case_left-post'>
            ...
            <div className='case_right d-none d-md-block'>
              <div className='case_right-post'>
                <h3>E-Commerce</h3>
                <p>
                  TokToKey is a Blockchain based eCommerce platform with an
              ...
              <div className='case_right-post has-thumb'>
                <img src={logoTwo} alt='santiliana' id='santiliana'></img>
              </div>
              <div className='case_right-post'>
              ...
              <div className='case_right-post has-thumb'>
                <img src={logoFour} alt='ting' id='ting'></img>
              </div>
              <div className='case_right-post'>
                <h3>Crypto mining</h3>
                <p>
              ...
              <div className='case_right-post has-thumb'>
                <a href='https://www.wallace.world/' target='blank'>
                  <img src={logoSix} alt='wallace' id='wallace'></img>
                </a>
              </div>
            </div>
            <div className='case_left case_right d-md-none'>
              <div className='case_left-post'>
                <a href='https://toktokey.com/' target='blank'>
                  {' '}
                  <img src={logoOne} alt='toktokey' id='ttk'></img>
              ...
              <div className='case_right-post'>
                ...
                <ReadMoreReact
                  text='TokToKey is a Blockchain based eCommerce platform with an
                  immediate call to action features. The mobile and web
                  application provides a “see-now-buy-now” ability through
                  content recognition and product browsing, with comparisons.
                  The system also supports a conventional eCommerce desktop
              ...
              <div className='case_left-post'>
                ...
                <ReadMoreReact
                  text=' The Santiliana project is a fuel distribution network, an
                  established successful business for more than 20 years in
                  Romania. It operates high volume, serviced, modular micro
                  diesel and/or gasoline filling stations. The locations are
                  carefully selected to ensure high volume turnover of stocks in
              ...
              <div className='case_right-post'>
                ...
                <ReadMoreReact
                  text=' Metalum is a blockchain-based metals trade ecosystem. Metalum
                  is as a collaborative digital marketplace with analytical
                  features linked to the metals supply chain from production
                  processes, assaying, trade financing, warehousing, logistics,
                  shipping, delivery etc. The P2P trading platform closes deals
              ...
              <div className='case_left-post'>
                ...
                <ReadMoreReact
                  text='Utilizing the Core Tube streaming and TokToKey e-commerce
                  backends, Ting is one of the most advanced borderless and
                  inclusive platforms to distribute content and merchandise
                  specifically aimed for merchants and people to be able to
                  promote their products on their individual custom channels to
              ...
              <div className='case_right-post'>
                ...
                <ReadMoreReact
                  text=' CMiners crypto mining is powered by waste energy recovered
                  from multiple resources such as solar, hydro, wind and
                  mechanical accumulator installations as well as waste
                  processing installations. The technology can best be described
                  as creating wealth from waste energy. Together with CMiners
              ...
              <div className='case_right-post'>
                ...
                <div className='case_left-post'>
                  <h3>Community network</h3>
                  <p>
                    Wallace is a humanitarian liquidity blockchain based
                    community network. It empowers new generations with access
                    to an accountability and impact investment measurement
                    platform. Built on Core Blockchain and Core Mesh Technology,
                    Wallace is a self-sustainable decentralized ecosystem with a
                    98% global reach, making it the only blockchain based
                    network with access for everyone in the world to a fully
                    inclusive digital economy. Wallace provides access to
                    health, education, social, financial services platforms
                    rewarding the Wallace Community with access to stable income
                    and job opportunities regardless of your geographical
                    position.
                  </p>
                  <ReadMoreReact
                    text=' Wallace is a humanitarian liquidity blockchain based community
                  network. It empowers new generations with access to an
                  accountability and impact investment measurement platform.
                  Built on Core Blockchain and Core Mesh Technology, Wallace is
                  a self-sustainable decentralized ecosystem with a 98% global
